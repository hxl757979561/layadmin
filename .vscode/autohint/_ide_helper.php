...
namespace Illuminate\Support\Facades { 
    ...
    class Auth {
         ...
         *
         * @return \Services\models\m\User|null 
         * @static 
         */ 
         ...
         *
         * @param mixed $id
         * @return \Services\models\m\User|false 
         * @static 
         */ 
...
namespace Illuminate\Support\Facades {
    class Route {
         ...
         * @return \Illuminate\Routing\RouteRegistrar
         */
        public static function as(string $value){ }
         ...
         * @return \Illuminate\Routing\RouteRegistrar
         */
        public static function middleware(string $value){ }
    ...
    class Redis extends \Illuminate\Redis\RedisManager {}
    class Redis extends \Illuminate\Contracts\Redis\Factory {}
}

namespace Illuminate\Redis\Connections {
    class Connection extends \Illuminate\Support\Facades\Redis {}
}
...
namespace Illuminate\Routing {
    class RouteRegistrar {
        ...
        public function prefix(string $value){
            return \Illuminate\Support\Facades\Route::prefix($value);
        }
        ...
        public function as(string $value){ 
            return \Illuminate\Support\Facades\Route::as($value);
        }
        ...
        public function domain(string $value){ 
            return \Illuminate\Support\Facades\Route::domain($value);
        }
         ...
         * @return \Illuminate\Routing\RouteRegistrar
         */
        public function middleware(string $value){ 
            return \Illuminate\Support\Facades\Route::middleware($value);
        }
        ...
        public function name(string $value){ 
            return \Illuminate\Support\Facades\Route::name($value);
        }
        ...
        public function namespace(string $value){ 
            return \Illuminate\Support\Facades\Route::namespace($value);
        }
...
namespace Illuminate\Database\Eloquent {
    ...
    class Model extends \Illuminate\Database\Eloquent\Builder {
        ...
        /** @var \Illuminate\Support\Carbon $updated_at */
        public $updated_at;

        /** @var \Illuminate\Support\Carbon $deleted_at */
        public $deleted_at;
    }
}
...
namespace Illuminate\Notifications {
    trait HasDatabaseNotifications{
         ...
         * @var \Illuminate\Notifications\DatabaseNotificationCollection $unreadNotifications
         */
        public $unreadNotifications;
        
        /**
         * Get all read notifications.
         * @var \Illuminate\Notifications\DatabaseNotificationCollection $readNotifications
         */
