    ...
    var $ = layui.jquery,
        ...
        admin = {
                    ...
                    $.extend(
                        {
                            ...
                            shadeClose: true,
                            skin:
                                "layui-anim layui-anim-rl layui-layer-adminRight",
                            area: "300px"
                        },
                        options
                    )
            ...
            sendAuthCode: function(options) {
                ...
                $body
                    .off("click", options.elem)
                    .on("click", options.elem, function() {
        ...
        serach: function(othis) {
            othis.off("keypress").on("keypress", function(e) {
                ...
                if (e.keyCode === 13) {
                    ...
                    if (
                        this.value === events.serach.keys[admin.tabsPage.index]
                    ) {
                ...
                list.each(function(index1, item1) {
                    var othis1 = $(item1),
                        ...
                        matched1 =
                            ...
                            (index1 === 0 && !path[0]) ||
                            (data1.jump &&
                                pathURL == admin.correctRouter(data1.jump));
                        ...
                        var othis2 = $(item2),
                            ...
                            matched2 =
                                (path[0] == data1.name &&
                                    path[1] == data2.name) ||
                                (data2.jump &&
                                    pathURL == admin.correctRouter(data2.jump));
                        ...
                        listChildren2.each(function(index3, item3) {
                            var othis3 = $(item3),
                                ...
                                matched3 =
                                    ...
                                    (data3.jump &&
                                        pathURL ==
                                            admin.correctRouter(data3.jump));

                            if (matched3) {
                                var selected = data3.list[0]
                                    ? SIDE_NAV_ITEMD
                                    : THIS;
                                othis3
                                    .addClass(selected)
